...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-12 md:gap-20">
        <div className="about-logo flex-shrink-0" style={{ perspective: 1000 }}>
          <div
            className="relative w-48 h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden liquid-glass-morphic"
            style={{
